...
import { parseTasks, calculateProgress } from "../../src/utils/plan-content";
import type { SpecInput, ImplementationInput } from "../../src/types";
...
describe("generateSpecMarkdown", () => {
  ...
  test("handles multiple items in each section", () => {
    const spec: SpecInput = {
      ...
      acceptanceCriterias: ["Criteria 1", "Criteria 2", "Criteria 3", "Criteria 4"],
      outOfScope: ["Out 1"],
    };
