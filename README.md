...
The `examples/` folder contains complete plan folders generated by agents using this plugin, including `metadata.json`, `specifications.md`, and `implementation.md`:

| Example | Description |
| ------- | ----------- |
| [`feature_authentication-system-for-nestjs-rest-api_20260317_f6dd`](examples/feature_authentication-system-for-nestjs-rest-api_20260317_f6dd/) | Production-oriented NestJS authentication plan with JWT, refresh token rotation, RBAC, password reset, and test coverage requirements. |
| [`feature_telemetry-and-observability-opentelemetry-grafana-lgtm_20260315`](examples/feature_telemetry-and-observability-opentelemetry-grafana-lgtm_20260315/) | End-to-end observability plan covering OpenTelemetry instrumentation, provider abstraction, Docker Compose infrastructure, and verification steps. |

These are useful reference outputs for the level of detail and structure the plan tools are designed to produce.
